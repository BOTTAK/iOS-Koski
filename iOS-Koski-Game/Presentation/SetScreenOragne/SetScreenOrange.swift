...
class SetScreenOrange: UIViewController {
    //------------------------------------------------------------------------------
    // MARK:-
    // MARK:- Outlets
    //------------------------------------------------------------------------------
    ...
    @IBOutlet weak var orangeCircleView: UIView!
    ...
    func setupUI() {
        ...
        self.orangeCircleView.backgroundColor = .clear
        self.helpImg.backgroundColor = .clear
        self.gameImg.image = UIImage(named: "gamePlaceOragne")
    ...
    func addTargetToNextButton() {
        ...
        self.orangeCircleView.addGestureRecognizer(tap)
        self.orangeCircleView.isUserInteractionEnabled = true
    }
